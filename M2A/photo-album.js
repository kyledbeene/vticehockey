...
async function loadAlbumPhotos() {
	if (!album) return;
	try {
		const response = await fetch(`https://api.github.com/repos/kyledbeene/vticehockey/contents/M2A/photos/${encodeURIComponent(album)}`);
